...
export default function AboutPage() {
  ...
  return (
    ...
    <div className="min-h-screen relative" style={{ background: 'linear-gradient(170deg, #f5f3ff 0%, #ede9fe 35%, #faf5ff 70%, #ffffff 100%)' }}>
      {/* 光斑装饰 */}
      <div className="fixed top-[10%] right-[-8%] w-[450px] h-[450px] bg-purple-300/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="fixed bottom-[5%] left-[-5%] w-[350px] h-[350px] bg-violet-200/15 rounded-full blur-[100px] pointer-events-none" />
      <div className="fixed top-[50%] left-[40%] w-[250px] h-[250px] bg-indigo-200/10 rounded-full blur-[80px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-4 py-20 relative z-10">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
          className="prose max-w-none mb-16 p-8 bg-white/55 backdrop-blur-xl rounded-2xl border border-white/50 shadow-sm"
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {about.skills.map(group => (
                <div key={group.category} className="relative overflow-hidden rounded-2xl bg-white/55 backdrop-blur-xl border border-white/50 shadow-sm hover:shadow-md transition-all duration-500">
          ...
          >
            ...
            <div className="space-y-4">
              {about.education.map(edu => (
                <div key={edu.school} className="flex items-start gap-4 p-5 bg-white/55 backdrop-blur-xl rounded-2xl border border-white/50 shadow-sm">
